                    ...
                    <nav class="navbar navbar-collapse bg-white navbar-light px-0">
                        <div class="d-flex align-items-center">
                            ...
                            @else
                                @if (Request::url() == url('/'))
                                    <h1 class="mb-0">
                                        @endif
                                        <a href="{{ url('/') }}">
                                            <img class="mr-4 mr-lg-5" src="{{ get_image_url(theme_option('logo', Theme::asset()->url('images/logo.png'))) }}" alt="{{ theme_option('site_title') }}" height="50">
                                        </a>
                                        @if (Request::url() == url('/'))
                                    </h1>
                                @endif
                            ...
                            <div class="d-none d-lg-block text-left">
                                <h2 class="title mb-0">Bootstrap 4 themes</h2>
                            </div>
                        </div>
